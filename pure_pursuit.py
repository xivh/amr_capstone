...
def main():
    ...
    #  target course !!!needs to be changed
    ...
    while T >= time and lastIndex > target_ind:
        ...
        deltai, target_ind = pure_pursuit_steer_control(
            state, target_course, target_ind)

        state.update(ai, deltai)  # Control vehicle

        vel.linear.x = state.v
        vel.angular.z = state.yaw
        vel_pub.publish(vel)
        rate.sleep()
